...
<div align="center">
  <b>PC 端 Agent 模式</b><br>
  <!-- TODO: 替换为实际截图 -->
  <img src="docs/images/example_agent_pc.png" alt="PC 端 Agent 模式" />
</div>
...
- **流式生成预览**：Responses API 模式下支持流式接收图像，实时显示局部渐变预览。
...
- **优化的图片查看与下载**：大图预览支持左右滑动切换、移动端长按弹出操作菜单，下载时自动使用描述性文件名。
